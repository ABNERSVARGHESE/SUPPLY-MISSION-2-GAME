...
function setup() {
	...
	boxSprite1=createSprite(300,620,20,100);
	boxSprite1.shapeColor=("red");

	boxSprite2=createSprite(500,620,20,100);
	boxSprite2.shapeColor=("red");

	boxSprite3=createSprite(400,660,200,20);
	...
	box2 = Bodies.rectangle(500,620,20,100 , {isStatic:true} );
 	World.add(world, ground);
